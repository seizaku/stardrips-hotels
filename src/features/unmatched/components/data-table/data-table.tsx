...
import { UnmatchedListing } from "~/server/api/routers/unmatched-listings/router";
...
export const DataTable = <TValue,>({
  ...
  columns: ColumnDef<UnmatchedListing, TValue>[];
  data: UnmatchedListing[];
  isLoading?: boolean;
  numRows: number;
}) => {
  ...
  return (
    <div className="overflow-x-auto">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        {numRows} total unmatched.
      </p>
      <p className="max-w-2xl text-sm">
        {`This table shows all the hotel listings that are not matched yet with any of our listings`}
      </p>

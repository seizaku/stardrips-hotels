...
interface DataTable {
  columns: ColumnDef<HotelMetrics>[];
  data: HotelMetrics[];
  maxSize: number;
}
...
const DataTable = ({ columns, data, maxSize }: DataTable) => {
  ...
  return (
    <div className="overflow-x-auto">
      <h1 className="text-2xl font-medium">Hotel Metrics</h1>
      <p className="mb-2 text-sm text-muted-foreground">
        {maxSize} total rows.
      </p>
      <p className="max-w-2xl text-sm">
        {`This table shows each hotel or hotel group from the emails received, including the first and last email, the average date between emails, and all the emails that subscribed to this hotel.`}{" "}
      </p>

  ...
  return (
    <div className="overflow-x-auto">
      ...
      <p className="mb-2 text-sm text-muted-foreground">
        {data?.length || 0} total promotions.
      </p>
      <p className="max-w-2xl text-sm">
        {`This table shows all extracted promotions from emails. When an email is
        received, Stardrips checks if it's a promo, retrieves the details using
        Gemini, and converts them to structured format.`}
      </p>
        ...
        <div className="flex w-full max-w-lg items-center gap-2 text-sm text-muted-foreground">
          ...
          <Input
            ...
            onChange={(e) =>
              setPagination((prev) => ({
                ...prev,
                pageIndex: parseInt(e.currentTarget?.value || "1"),
              }))
            }
          />
